...
from test import DefaultClientTest
...
#    }
    ...
    def test_create_subnet2(self):
        ...
        self.validateSubnet(subnet, network_id=network_id, cidr="10.0.3.0/24", enable_dhcp=True, ip_version=6, allocation_pools=[{"start": "10.0.3.20", "end": "10.0.3.150"}],gateway_ip="10.0.2.1", name="sample_subnet")
